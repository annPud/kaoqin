...
//        ];
        ...
        weekday = "星期" + weekday[date_obj.getDay()];
...
//        var clock_date = month + ' ' + day + ', ' + year;
        var clock_time = year + '年' + month + '月' + day + '日 ' + weekday + ' ' + hour + ':' + minute + ' '; 
...
//          return false;
         ...
         * 事件绑定
         */
        d.on('dblclick','#icon_kaoqin',function(){
        	$('#window_content_kaoqin').load('/kaoqin/kaoqin');
        });
      },
      wallpaper: function() {
